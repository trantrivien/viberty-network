...
export const metadata: Metadata = {
  title: "Viberty Network Modals | Viberty Network Dashboard Template",
  description:
    "This is Viberty Network Modals page for Viberty Network Tailwind CSS Admin Dashboard Template",
  // other metadata
};
