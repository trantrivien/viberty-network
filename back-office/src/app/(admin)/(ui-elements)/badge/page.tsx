...
export const metadata: Metadata = {
  title: "Viberty Network Badge | Viberty Network Dashboard Template",
  description:
    "This is Viberty Network Badge page for Viberty Network Tailwind CSS Admin Dashboard Template",
  // other metadata
};
