...
export const metadata: Metadata = {
  title: "Viberty Network Avatars | Viberty Network Dashboard Template",
  description:
    "This is Viberty Network Avatars page for Viberty Network Tailwind CSS Admin Dashboard Template",
};
