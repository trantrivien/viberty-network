  ...
  return (
    <div className="relative">
      <div className="relative inline-block h-[33px] rounded-[10px] bg-[#0F0F0F] px-[10px] py-[6px] lg:h-16 lg:px-5 lg:py-3">
        <div className="absolute inset-0 rounded-[10px] border border-[#FDC70C]" />
      ...
      {comingSoon && (
        <div className="relative -top-3 flex justify-center lg:-top-4">
          <div className="relative inline-flex rounded-md  bg-gradient-to-b from-[#FDC70C]/50 to-[#FDC70C]/10 px-2 py-0.5 text-center lg:px-3">
