...
export default function PrivacyPage() {
  return (
    <div className="max-w-[1400px] mx-auto p-10">
      <h1 className="text-[100px] my-10 text-center font-bold">Privacy Policy</h1>
      ...
      <ul>
        ...
        <li>
          <p>
            <strong>Application</strong> refers to Viberty, the software program
        ...
        <li>
          <p>
            ...
            this Agreement) refers to Viberty.
          </p>
        </li>
        <li>
          <p>
      ...
      <ul>
        <li>
          ...
          <a
            href="https://viberty.network/"
            rel="external nofollow noopener"
            target="_blank"
          >
            https://viberty.network/
          </a>
        </li>
      </ul>
    </div>
